...
plt.plot(N, time_jacobi,c = "mediumblue" ,label=" $\log_{10}(t) $ = " + str("%.3f" % slope_jacobi) + " $\pm$ " + str("%.3f" % dslope_jacobi))
plt.plot(N, time_arma,c = "k" ,label="$\log_{10}(t) $  = " + str("%.3f" % slope_arma) + " $\pm$ " + str("%.3f" % dslope_arma))
